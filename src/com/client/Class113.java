   ...
   void method2570(byte[] var1) {
      ...
      if (this.field1470 != null) {
         ...
         for(var43 = 0; var43 < var10; ++var43) {
            ...
            if (var44 != 255) {
               if (this.field1477[var43] == (this.field1476[var44] & '\uffff') && this.field1465[var43] == (this.field1491[var44] & '\uffff') && this.field1466[var43] == (this.field1464[var44] & '\uffff')) {
      ...
      if (this.field1484 > 0 && this.field1470 != null) {
         ...
         for(var11 = 0; var11 < this.field1484; ++var11) {
            if (var9[var11] > 0 && this.field1459[var11] == 0) {
               var8.field1621[var10] = this.field1476[var11] & '\uffff';
               var8.field1599[var10] = this.field1491[var11] & '\uffff';
               var8.field1600[var10] = this.field1464[var11] & '\uffff';
               var9[var11] = var10++;
            } else {
               var9[var11] = -1;
            }
         ...
         if (var12 == -1) {
            if (var17 != 0) {
               if (var17 == 1) {
                  ...
                  var8.field1615[var16] = method2590(this.field1471[var16] & '\uffff', var14);
               ...
               int var15 = this.field1471[var16] & '\uffff';
