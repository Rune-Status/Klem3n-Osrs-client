...
public class Class174 {
   ...
   public int method3475(byte[] var1, int var2, int var3, byte[] var4, int var5) {
      int var6 = 0;
      int var7 = var5 << 3;

      for(var3 += var2; var2 < var3; ++var2) {
         int var8 = var1[var2] & 255;
         int var9 = this.field2265[var8];
         byte var10 = this.field2264[var8];
         if (var10 == 0) {
   ...
   public int method3480(byte[] var1, int var2, byte[] var3, int var4, int var5) {
      if (var5 == 0) {
         return 0;
      } else {
         int var6 = 0;
         ...
         while(true) {
            byte var8 = var1[var7];
            if (var8 < 0) {
               var6 = this.field2267[var6];
            } else {
               ++var6;
            }

            int var9;
            if ((var9 = this.field2267[var6]) < 0) {
               var3[var4++] = (byte)(~var9);
               if (var4 >= var5) {
                  break;
               }
