...
public class Class151 implements Runnable {
   ...
   static int method3240(int var0, Class84 var1, boolean var2) {
      if (var0 == 6200) {
         Class69.field1003 -= 2;
   ...
   static String method3239(Class230 var0) {
      if (Class154.method3252(Class24.method425(var0)) == 0) {
         return null;
      } else {
         return var0.field2661 != null && var0.field2661.trim().length() != 0 ? var0.field2661 : null;
      }
   }
}
